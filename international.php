  ...
  <!-- 
	...
	<body>
		...
		<div class="fh5co-hero fh5co-hero-2">
			...
			<div class="fh5co-cover fh5co-cover_2 text-center" data-stellar-background-ratio="0.5" style="background-image: url(images/international.jpg);">
				<div class="desc animate-box">
					<h2>International Achievment</h2>
				</div>
			</div>
