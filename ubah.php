...
<form action="" method="post" enctype="multipart/form-data">
	<div class="body"></div>
		<div class="grad"></div>
			...
			<br>
	<div class="login">
		<div class="h2"><div>Edit Your Profile</div></div>
			<input type="hidden" name="id" value="<?= $usr["id"]; ?>">
			<input type="text" name="fullname" placeholder="Fullname" required value="<?= $usr["fullname"]; ?>"/>
			<input type="text" name="username" placeholder="Username" required value="<?= $usr["username"]; ?>"/>
			<input type="text" name="email" placeholder="E-mail" required value="<?= $usr["email"]; ?>"/>
			<input type="password" name="password" placeholder="Password" required value="<?= $usr["password"]; ?>"/>
			<input type="password" name="password2" placeholder="Retype password" required value="<?= $usr["password"]; ?>"/>
