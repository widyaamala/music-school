		...
		<div id="fh5co-wrapper">
			<div id="fh5co-page">
								...
								<nav id="fh5co-menu-wrap" role="navigation">
									<ul class="sf-menu" id="fh5co-primary-menu">
										...
										<li>
											...
											<ul class="fh5co-sub-menu">
												<li><a href="international.php" class="fh5co-sub-ddown">International</a></li>
										...
										<li>
											<a class="fh5co-sub-ddown">Profile</a>
											 <ul class="fh5co-sub-menu">
												<li><a href="ubah.php" class="fh5co-sub-ddown">Edit Profile</a></li>
				...
				<div class="fh5co-hero fh5co-hero-2">
					...
					<div class="fh5co-cover fh5co-cover_2 text-center" data-stellar-background-ratio="0.5" style="background-image: url(images/drum2.jpg);">
					...
					<div class="container">
						<div class="row row-bottom-padded-md">
							<div class="col-md-6 animate-box">
								<figure>
									<img src="images/orchestra.jpg" alt="Free HTML5 Bootstrap Template by FREEHTML5.co" class="img-responsive">
								</figure>
							</div>
							<div class="col-md-6 animate-box">
								<h3>Simple &amp; Humble Beginning</h3>
								<p>Sampai saat ini sudah ada 1000 orang yang mengikuti Noowidie Music School</p>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="row text-center">
							<div class="col-md-4 col-sm-4">
								<div class="services animate-box">
									<span><i class="" ><img src="images/icon-guitar.ico"></i></span>
									<h3>Guitar Lesson</h3>
								</div>
							</div>
							<div class="col-md-4 col-sm-4">
								<div class="services animate-box">
									<span><i class=""><img src="images/icon-drum.ico"></i></span>
									<h3>Drum Lesson</h3>
								</div>
							</div>
							<div class="col-md-4 col-sm-4">
								<div class="services animate-box">
									<span><i class=""><img src="images/icon-piano.ico"></i></span>
									<h3>Piano Music</h3>
								</div>
							</div>
							<div class="col-md-6 col-sm-3">
								<div class="services animate-box">
									<span><i class=""><img src="images/icon-violin.ico"></i></span>
									<h3>Violin Lesson</h3>
								</div>
							</div>
							<div class="col-md-6 col-sm-3">
								<div class="services animate-box">
									<span><i class=""><img src="images/icon-saxophone.ico"></i></span>
