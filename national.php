  ...
  <!-- 
	...
	<body>
					...
					<div class="nav-header">
						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<li><a href="lecturer.hp">Lecturer</a></li>
		...
		<div class="fh5co-hero fh5co-hero-2">
			...
			<div class="fh5co-cover fh5co-cover_2 text-center" data-stellar-background-ratio="0.5" style="background-image: url(images/national.jpg);">
				<div class="desc animate-box">
					<h2>National Achievment</h2>
				</div>
			</div>
