  ...
  <!-- 
	...
	<body>
		...
		<div class="fh5co-hero fh5co-hero-2">
			...
			<div class="fh5co-cover fh5co-cover_2 text-center" data-stellar-background-ratio="0.5" style="background-image: url(images/lecturer.jpg);">
				...
				<div class="row">
					<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							<img class="img-responsive" src="images/lecturer1.jpg" alt=""></a>
							<div class="blog-text">
								<div class="prod-title">
									<h3>Dieni Anindyasarathi</h3>
									<p>Guitar and Drum Lecturer</p>
								</div>
							</div> 
						</div>
					</div>
					<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							<img class="img-responsive" src="images/lectur2.jpg" alt=""></a>
							<div class="blog-text">
								<div class="prod-title">
									<h3>Nooriza Fariha R.</h3>
									<p>Piano Lecturer</p>
								</div>
							</div> 
						</div>
					...
					<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							<img class="img-responsive" src="images/lectur3.jpg" alt=""></a>
							<div class="blog-text">
								<div class="prod-title">
									<h3>Widya Amala S.</h3>
									<p>Violin Lecturer</p>
					...
					<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							<img class="img-responsive" src="images/lecturer (4).jpeg" alt=""></a>
							<div class="blog-text">
								<div class="prod-title">
									<h3>Dilla Mustika S.</h3>
									<p>Piano Lecturer</p>
								</div>
							</div> 
						</div>
					...
					<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							<img class="img-responsive" src="images/lecturer (5).jpg" alt=""></a>
							<div class="blog-text">
								<div class="prod-title">
									<h3>Putri Indhira</h3>
									<p>Saxophone Lecturer</p>
								</div>
							</div> 
						</div>
					</div>
					<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							<img class="img-responsive" src="images/lecturer (6).jpg" alt=""></a>
							<div class="blog-text">
								<div class="prod-title">
									<h3>Tia Masherly B.</h3>
									<p>Drum Lecturer</p>
								</div>
							</div> 
						</div>
