  ...
  <!-- 
	...
	<body>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style="background-image: url(images/teens.jpg);">
				<div class="desc animate-box">
					<h2><strong>TEENS COURSE</strong></h2>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 work">
						<div class="row">
							<div class="col-md-6 col-md-pull-2">
								<div class="half-inner" style="background-image:url(images/teens-guitar.jpg);">
								</div>
							</div>
							<div class="col-md-6 animate-box">
								<div class="desc">
									...
									<p>For Beginner</p>
									<p><a class="btn btn-primary btn-lg popup-vimeo btn-video" href="https://www.youtube.com/watch?v=smh7vLIUH_Q"><i class="icon-play"></i> Watch Video</a></p>
								</div>
					...
					<div class="col-md-12 work">
						<div class="row">
							<div class="col-md-6 col-md-push-6">
								<div class="half-inner half-inner2" style="background-image:url(images/teens-drum.jpg);">
								</div>
							</div>
							<div class="col-md-6 col-md-pull-6 animate-box">
								<div class="desc desc2">
									...
									<p>For Beginner</p>
									<p><a class="btn btn-primary btn-lg popup-vimeo btn-video" href="https://www.youtube.com/watch?v=et9hU7QMDYU"><i class="icon-play"></i> Watch Video</a></p>
								</div>
								<form action="" method="post">
                                <div class="col-md-12">
                                    <div class="form-group">
					...
					<div class="col-md-12 work">
						<div class="row">
							<div class="col-md-6 col-md-pull-2">
								<div class="half-inner" style="background-image:url(images/teens-piano.jpg);">
								</div>
							</div>
							<div class="col-md-6 animate-box">
								<div class="desc">
									...
									<p>For Beginner</p>
									<p><a class="btn btn-primary btn-lg popup-vimeo btn-video" href="https://www.youtube.com/watch?v=SjEJccwOR0M"><i class="icon-play"></i> Watch Video</a></p>
								</div>
								<form action="" method="post">
                                <div class="col-md-12">
                                    <div class="form-group">
					...
					<div class="col-md-12 work">
						<div class="row">
							<div class="col-md-6 col-md-push-6">
								<div class="half-inner half-inner2" style="background-image:url(images/teens-violin.jpg);">
								</div>
							</div>
							<div class="col-md-6 col-md-pull-6 animate-box">
								<div class="desc desc2">
									...
									<p>For Beginner</p>
									<p><a class="btn btn-primary btn-lg popup-vimeo btn-video" href="https://www.youtube.com/watch?v=dYfMQF0-pHU"><i class="icon-play"></i> Watch Video</a></p>
								</div>
								<form action="" method="post">
                                <div class="col-md-12">
                                    <div class="form-group">
					...
					<div class="col-md-12 work">
						<div class="row">
							<div class="col-md-6 col-md-pull-2">
								<div class="half-inner" style="background-image:url(images/teens-saxophone.jpg);">
								</div>
							</div>
							<div class="col-md-6 anihmate-box">
								<div class="desc">
									...
									<p>For Beginner</p>
									<p><a class="btn btn-primary btn-lg popup-vimeo btn-video" href="https://www.youtube.com/watch?v=EEqn3sMXke0"><i class="icon-play"></i> Watch Video</a></p>
								</div>
							</div>
						</div>
					</div>
